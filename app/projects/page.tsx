    ...
    <div className="pt-32">
      <section className="relative py-20 text-white overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/project3.DNG-dVBoe5BpkUtFAouTorn402Bn9Y5eef.jpeg"
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block bg-mid-green/20 border border-mid-green/30 px-4 py-2 rounded mb-6">
              <span className="text-mid-green font-bold text-sm uppercase tracking-wide">Project Portfolio</span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-10 border-t border-white/20">
              ...
              <div>
                ...
                <div className="text-white/70 text-sm">States Served</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 bg-white border-b border-border">
        <div className="container">
          <div className="flex flex-wrap items-center gap-6">
            ...
            {/* Service filter */}
            <div className="flex flex-wrap items-center gap-3">
              <span className="text-sm text-muted font-medium">Service:</span>
              <button
        ...
        <div className="container">
          {filteredProjects.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-muted text-sm">No projects found matching your filters.</p>
            </div>
          ) : (
              ...
              {filteredProjects.map((project) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-muted text-sm mb-4 leading-relaxed">{project.scope}</p>
                    <div className="flex items-center justify-between pt-4 border-t border-border">
                      <p className="text-charcoal font-bold text-sm">{project.result}</p>
