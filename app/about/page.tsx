    ...
    <div className="pt-32">
      ...
      <section className="relative py-20 text-white overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/23.png-cfH6ISHUk6SAP2PSppBtJWAhXT4hy2.jpeg"
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block bg-accent/20 border border-accent/30 px-4 py-2 rounded mb-6">
              <span className="text-accent font-bold text-sm uppercase tracking-wide">About Sinocle Nigeria</span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-10 border-t border-white/20">
              <div>
                ...
                <div className="text-white/70 text-sm">Year Founded</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-white/70 text-sm">Infrastructure Value</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-spacing bg-white">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="text-accent font-bold text-sm uppercase tracking-wide mb-4">Our Company</div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-bold text-foreground text-sm">ISO 9001:2015 Certified</div>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-4 w-4 text-accent flex-shrink-0 mt-0.5" />
                  <div>
                    <div className="font-bold text-foreground text-sm">COREN Registered</div>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-4 w-4 text-accent flex-shrink-0 mt-0.5" />
                  <div>
                    <div className="font-bold text-foreground text-sm">CAC Registered</div>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-4 w-4 text-accent flex-shrink-0 mt-0.5" />
                  <div>
                    <div className="font-bold text-foreground text-sm">Zero HSE Incidents</div>
      ...
      <section className="section-spacing bg-surface">
        <div className="container">
          <div className="text-center mb-16">
            <div className="text-accent font-bold text-sm uppercase tracking-wide mb-4">Company History</div>
              ...
              {timeline.map((item, index) => (
                <div key={index} className="relative">
                  <div className="bg-white rounded p-6 shadow-lg h-full">
                    ...
                    <h3 className="text-sm font-bold mb-3 text-foreground">{item.title}</h3>
      ...
      <section className="section-spacing bg-white">
        <div className="container">
          <div className="text-center mb-16">
            <div className="text-accent font-bold text-sm uppercase tracking-wide mb-4">Core Values</div>
      ...
      <section className="section-spacing bg-surface relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="text-accent font-bold text-sm uppercase tracking-wide mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8 border-t border-muted/20">
              <div>
                ...
                <div className="text-muted text-sm uppercase tracking-wide">Major HSE Incidents (2024)</div>
              </div>
              <div>
                <div className="text-accent text-xl font-bold mb-2">100%</div>
                <div className="text-muted text-sm uppercase tracking-wide">PPE Compliance Rate</div>
              </div>
              <div>
                <div className="text-accent text-xl font-bold mb-2">Daily</div>
                <div className="text-muted text-sm uppercase tracking-wide">Safety Briefings</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-spacing bg-surface">
        <div className="container">
          <div className="text-center mb-16">
            <div className="text-accent font-bold text-sm uppercase tracking-wide mb-4">Our Team</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <div key={index} className="bg-white rounded p-6 text-center shadow-lg">
                ...
                <h3 className="text-sm font-bold mb-2 text-foreground">{member.name}</h3>
      ...
      <section className="section-spacing bg-white">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <div className="text-accent font-bold text-sm uppercase tracking-wide mb-4">Get In Touch</div>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-primary hover:bg-primary-hover text-white font-bold px-6 py-3 md:px-5 md:py-2.5 text-sm rounded transition-all duration-300 hover:scale-105 shadow-lg"
            >
